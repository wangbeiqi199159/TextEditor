	...
	public static void main(String [] args) {
				...
				numToCheck += increment)
		{
			 ...
			 */  
			 ...
			 long basicTimeEnd = System.nanoTime();
			 double basicTime = (basicTimeEnd - basicTimeStart) / 100000000.0;

			long efficientTimeStart = System.nanoTime();
			Document efficient = new EfficientDocument(text);
			efficient.getFleschScore();
			long efficientTimeEnd = System.nanoTime();
			double efficientTime = (efficientTimeEnd - efficientTimeStart) / 100000000.0;
